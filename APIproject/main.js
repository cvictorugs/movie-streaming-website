        ...
        html += `
          <div class="movie">
            ...
            <div class="movie-details">
              <h2><a href="movie.html?id=${movie.imdbID}">${movie.Title} (${movie.Year})</a></h2>
            </div>
          </div>
        `;
      });
...
let images = [`darkphoenix.png`, `differentman.jpg`, `thingsdifferent.png`, `alladin.jpg`, `starwars_uusi_vaaka.jpg`];
let texts = [
  `<div class="themovie">
          <p>Movie</p>
    </div>
